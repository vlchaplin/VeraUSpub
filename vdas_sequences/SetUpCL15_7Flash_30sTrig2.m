...
SFormat.transducer = 'CL15-7'; % 256 element linear array with 0.96 lambda spacing
...
for i = 1:Resource.RcvBuffer(1).numFrames
    for j = 1:numacq, 
        Event(n).info = 'Flash transmit';
        Event(n).tx = 0;%j;         % use 1st TX structure.
