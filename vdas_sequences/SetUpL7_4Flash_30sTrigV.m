clear all
VSXName='C:\Users\verasonics\Desktop\Vantage-3.0.4/MatFiles/L7_4FlashV';

%% Define variables
opath = 'C:\Users\verasonics\Desktop\Vantage-3.0.4\Vandiver\sonalleve_0607'; % path to output files
oname = '3foc-agar-1000av-2';
...
Resource.RcvBuffer(2).numFrames = 1;%300;%60;  % try 60 for 3 seconds worth of data % 50 frames used for RF cineloop.
...
for i = 1:Resource.RcvBuffer(1).numFrames
    for j = 1:numacq, 
        ...
        Event(n).process = 0;    % no processing
        if trigger && (i==1 && j==2)
            Event(n).seqControl = [3,6]; % time between acqs.
        else
            Event(n).seqControl = 3; % time between acqs.
        end
        n = n+1;
    end
