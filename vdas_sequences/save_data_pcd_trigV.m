function save_data_pcd_trigV(RcvData)
disp('Saving data..!.');
tic;
...
try
    us_between_acq= evalin('base','us_between_acq');
catch
    us_between_acq=-1;
end

try
    hifuOnTime_us = evalin('base','hifuOnTime_us');
catch
    hifuOnTime_us=-1;
end
...
params.num_final_bmode_acs=num_final_bmode_acs;
params.us_between_acq = us_between_acq;
params.hifuOnTime_us = hifuOnTime_us;
